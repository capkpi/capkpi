...
The Issue list is not the right place to ask a question or start a general discussion. If you want to do that , then the right place is the forum ~~<https://discuss.capkpi.com>~~ => [stackoverflow](https://stackoverflow.com/questions/tagged/capkpi) tagged under `capkpi`.
