import capkpi
from capkpi.patches.v13_0.encrypt_2fa_secrets import DOCTYPE
from capkpi.patches.v13_0.encrypt_2fa_secrets import PARENT_FOR_DEFAULTS as TWOFACTOR_PARENT
...
def execute():
	...
	# letter head
	try:
		letter_head = capkpi.get_doc("Letter Head", {"is_default": 1})
