...
import capkpi
from capkpi.utils import markdown, strip_html_tags


def execute():
	capkpi.reload_doc("website", "doctype", "blog_post")

	for blog in capkpi.get_all("Blog Post"):
		blog = capkpi.get_doc("Blog Post", blog.name)
		capkpi.db.set_value(
