...
window.validate_email = function(txt) {
	return capkpi.utils.validate_type(txt, "email");
};

window.validate_phone = function(txt) {
	return capkpi.utils.validate_type(txt, "phone");
};

window.validate_name = function(txt) {
	return capkpi.utils.validate_type(txt, "name");
};

window.validate_url = function(txt) {
	return capkpi.utils.validate_type(txt, "url");
};
