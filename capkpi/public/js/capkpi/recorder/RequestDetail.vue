	...
	<div>
		<div class="row form-section visible-section shaded-section">
			<div class="section-body">
				<div class="form-column col-sm-12">
					<form>
						<div class="capkpi-control" :data-fieldtype="column.type" v-for="(column, index) in columns" :key="index" :class="column.class">
		...
		<div class="row form-section visible-section">
			...
			<div class="section-body">
				<div class="form-column col-sm-12">
					<form>
						<div class="form-group capkpi-control input-max-width" data-fieldtype="Check">
							<div class="checkbox">
								<label>
						...
						<div class="capkpi-control" data-fieldtype="Table">
							<div>
								<div class="form-grid">
																		...
																		<div class="section-body">
																			<div class="form-column col-sm-12">
																				<form>
																					...
																					<div class="capkpi-control input-max-width">
																						<div class="form-group">
																					...
																					<div class="capkpi-control" v-if="call.explain_result[0]">
																						<div class="form-group">
