...
capkpi.ui.Scanner = class Scanner {
	constructor(options) {
		this.dialog = null;
		this.handler = null;
		...
		if (options.container) {
			...
			this.scan_area_id = capkpi.dom.set_unique_id(this.$scan_area);
		}
		if (options.dialog) {
	...
	load_lib() {
		return capkpi.require(
			"/assets/capkpi/node_modules/html5-qrcode/dist/html5-qrcode.min.js"
		);
	}
};
