export default class GridPagination {
	...
	get_pagination_html() {
		...
		return $(`<button class="btn btn-secondary btn-xs first-page"">
			...
			<button class="btn btn-secondary btn-xs prev-page">${capkpi.utils.icon('left', 'xs')}</button>
			${page_text_html}
			<button class="btn btn-secondary btn-xs next-page">${capkpi.utils.icon('right', 'xs')}</button>
