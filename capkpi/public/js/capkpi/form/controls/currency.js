capkpi.ui.form.ControlCurrency = capkpi.ui.form.ControlFloat.extend({
	...
	get_precision: function() {
		...
		if (!this.df.precision) {
			if(capkpi.boot.sysdefaults.currency_precision) {
				this.df.precision = capkpi.boot.sysdefaults.currency_precision;
			} else {
