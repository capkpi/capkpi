capkpi.ui.form.ControlDuration = capkpi.ui.form.ControlData.extend({
	make_input: function() {
		this._super();
		this.make_picker();
	},
	...
	set_duration_options() {
		this.duration_options = capkpi.utils.get_duration_options(this.df);
	},

	set_duration_picker_value: function(value) {
		let total_duration = capkpi.utils.seconds_to_duration(value, this.duration_options);
	...
	bind_events: function() {
		...
		this.$picker.on("change", ".duration-input", () => {
			...
			let value = capkpi.utils.duration_to_seconds(
				duration.days,
				duration.hours,
				duration.minutes,
				duration.seconds
	...
	format_for_input: function(value) {
		return capkpi.utils.get_formatted_duration(value, this.duration_options);
	},
