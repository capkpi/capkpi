...
capkpi.views.Container = Class.extend({
	...
	change_to: function(label) {
		...
		this.page._route = capkpi.router.get_sub_path();
		$(this.page).trigger('show');
		!this.page.disable_scroll_to_top && capkpi.utils.scroll_to(0);
	...
	has_sidebar: function() {
		var flag = 0;
		var route_str = capkpi.get_route_str();
		// check in capkpi.ui.pages
		flag = capkpi.ui.pages[route_str] && !capkpi.ui.pages[route_str].single_column;

		// sometimes capkpi.ui.pages is updated later,
