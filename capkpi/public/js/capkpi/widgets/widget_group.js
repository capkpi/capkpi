...
capkpi.provide("capkpi.widget");

capkpi.widget.widget_factory = {
	chart: ChartWidget,
	base: BaseWidget,
...
capkpi.widget.make_widget = (opts) => {
	const widget_class = capkpi.widget.widget_factory[opts.widget_type];
	if (widget_class) {
...
export default class WidgetGroup {
	...
	add_widget(widget) {
		let widget_object = capkpi.widget.make_widget({
			...widget,
...
capkpi.widget.WidgetGroup = WidgetGroup;
