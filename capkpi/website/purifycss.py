...
sUpdate source and target apps below and run from CLI
	...
	bench --site [sitename] execute capkpi.website.purifycss.purify.css
...
source = capkpi.get_app_path("capkpi_theme", "public", "less", "capkpi_theme.less")
target_apps = [
	"erp_com",
	"capkpi_io",
	"translator",
...
def purifycss():
	...
	for app in target_apps:
		for basepath, folders, files in os.walk(capkpi.get_app_path(app)):
			for fname in files:
