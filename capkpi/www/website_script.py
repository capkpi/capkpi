...
from capkpi.website.doctype.website_theme.website_theme import get_active_theme

base_template_path = "templates/www/website_script.js"


def get_context(context):
	context.javascript = capkpi.db.get_single_value("Website Script", "javascript") or ""
	...
	if not capkpi.conf.developer_mode:
...
def get_setting(field_name):
	...
	website_settings = capkpi.db.get_single_value("Website Settings", field_name)
	conf = capkpi.conf.get(field_name)
