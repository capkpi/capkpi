...
import capkpi
from capkpi.core.page.background_jobs.background_jobs import remove_failed_jobs
...
class TestBackgroundJobs(unittest.TestCase):
	def test_remove_failed_jobs(self):
		capkpi.enqueue(method="capkpi.tests.test_background_jobs.fail_function", queue="short")
