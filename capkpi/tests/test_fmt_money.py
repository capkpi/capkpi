...
import capkpi
from capkpi.utils import fmt_money


class TestFmtMoney(unittest.TestCase):
	def test_standard(self):
		capkpi.db.set_default("number_format", "#,###.##")
	...
	def test_currency_precision(self):
		capkpi.db.set_default("currency_precision", "4")
		capkpi.db.set_default("number_format", "#,###.##")
		self.assertEqual(fmt_money(100), "100.00")
		self.assertEqual(fmt_money(1000), "1,000.00")
		self.assertEqual(fmt_money(10000), "10,000.00")
		...
		capkpi.db.set_default("currency_precision", "")
