...
class TestAddressTemplate(unittest.TestCase):
	...
	def test_default_is_unset(self):
		a = capkpi.get_doc("Address Template", "India")
		a.is_default = 1
		a.save()

		b = capkpi.get_doc("Address Template", "Brazil")
		b.is_default = 1
		b.save()

		self.assertEqual(capkpi.db.get_value("Address Template", "India", "is_default"), 0)
	...
	def make_default_address_template(self):
		...
		if not capkpi.db.exists("Address Template", "Brazil"):
			capkpi.get_doc(
